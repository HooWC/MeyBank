...
<% 
	...
	List<BankAccount> list2 = (List<BankAccount>)session.getAttribute("allbankacc");
%>
						...
						<table>
							<thead>
								<tr>
									...
									<th>Pin Number</th>
									<th>Balance</th>
									<th>Card CardLimitLimit</th>
								</tr>
							</thead>
							<tbody>
								<% for(BankAccount i : list2){ %>
								<% 
									String balance = String.format("%.2f", i.getBalance()).toString();
									String limit = String.format("%.2f", i.getAllLimit()).toString();
								
								%>
								<tr>
									<td data-title="Provider Name"><%= i.getAccountType() %></td>
									<td data-title="Provider Name"><%= i.getBankAccNo() %></td>
									<td data-title="Provider Name"><%= i.getCardNumber() %></td>
									<td data-title="Provider Name"><%= i.getPinNumber() %></td>
									<td data-title="Provider Name">RM <%= balance %></td>
									<td data-title="Provider Name">RM <%= limit %></td>
								</tr>
								<%} %>
							</tbody>
						</table>
