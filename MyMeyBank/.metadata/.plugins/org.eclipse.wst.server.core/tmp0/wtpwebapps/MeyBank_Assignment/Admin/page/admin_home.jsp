...
<% 
api_Admin api_admin = new api_Admin();
...
List<Admin> mylist = api_admin.getAdmin_list(admin.getAdminID());
session.setAttribute("Adminlist", mylist);

	Admin ad = (Admin)session.getAttribute("Admin");
	String month = (String)session.getAttribute("month");
	String day = (String)session.getAttribute("day");
	String mytime = (String)session.getAttribute("mytime");
    ...
    <div class="container-1" x-data="{ rightSide: false, leftSide: false }">
        ...
        <path d="M19 12H5M12 19l-7-7 7-7"/>
          ...
          <div class="side-wrapper">
            ...
            <div class="side-menu">
              <a href="admin_home.jsp" style="background:red;padding:8px 10px;border-radius:5px;color:white;">
              ...
              <a href="../../getallaccount">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
                  <circle cx="12" cy="10" r="3" /></svg>
                Manage Account
              </a>
              <a href="../../getAllContent">
          ...
          <div class="main-container">
            <div class="profile">
              ...
              <div class="profile-menu">
                <a class="profile-menu-link active">View</a>
              </div>
            </div>
            <div class="timeline">
              <div class="timeline-left">
                ...
                <div class="event box">
                  <div class="event-wrapper">
                    ...
                    <div class="event-subtitle"><%= mytime %></div>
                  </div>
                </div>
