...
<link rel="stylesheet" href="../css/user_selec.css">
<link
...
<%
		String msg = (String)session.getAttribute("updateuseradmin");
		if(msg == null){
			msg = "";
		}
	%>

<h1 id="userid" style="display:none;"><%= u.getUserID() %></h1>
			...
			<div class="side-wrapper">
				...
				<div class="side-menu">
                  ...
                  <path
					...
					</a> <a href="New_Admin.jsp"> <svg viewBox="0 0 56 58" width="512"
			...
			<div class="main-container">
				<div class="profile">
					...
					<div class="profile-menu">
						<a class="profile-menu-link active" style="color:white;">All</a>
					</div>
				</div>
				<div class="timeline">
              <div class="timeline-left">
                ...
                <figure class="snip1336 show">
                    ...
                    <figcaption>
                        <img
                            src="../../image/User/<%= u.getIMG() %>"
                            alt="profile-sample4" class="profile12" style="object-fit: cover;"/>
                        <h4>
                            <p><%= u.getGender() %></p>
                            <p style="font-size:1rem;"><%= u.getFullName() %></p><p><%= u.getBirthDate() %></p>
                        </h4>
                        <p><%= u.getEmail() %></p>
                    </figcaption>
                </figure>
              ...
              <div class="timeline-right">
                ...
                <div class="myr">
                    <div class="frame">
                        <button class="custom-btn btn-12" disabled id="update"><span>Click!</span><span>Update</span></button>
                      </div>
                      <div class="frame">
                      <% if(u.isActive() == true) {%>
                        <button class="custom-btn btn-13" id="delete"><span>Click!</span><span>Blocked</span></button>
                        <%} else{%>
                        <button class="custom-btn btn-13" id="delete"><span>Click!</span><span>Active</span></button>
                        <% } %>
                    </div>
                </div>
                ...
                <p style="color:red;"><%= msg %></p>
                    <div class="user-box">
                        <input type="text" name="Fullname" id="Fullname" value="<%= u.getFullName() %>" required>
                    ...
                    <div class="user-box">
                      <input type="text" name="nric" id="nric" value="<%= u.getNRIC() %>" onkeyup="value=value.replace(/\D/g,'')" onafterpaste="value=value.replace(/\D/g,'')" required>
                      <label>NRIC</label>
                    </div>
	    ...
	    $("#update").click(function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data == true){
						window.location.href = "../../Admin/page/m_user_home.jsp";
					}else{
						window.location.href = "../../Admin/page/user_select.jsp";
					}
