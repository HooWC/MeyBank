...
<body>
	...
	<section class="context-nei">
		...
		<div class="input-box">
			...
			<h1 class="input-box-title">Create New Bank Account</h1>
			<p class="input-box-title-p">Select Saving / Current bank type
				(S/C)</p>
			...
			<form action="../../newbankaccount" method="post">
					...
					<div class="item-bankchange">
						...
						<div class="item-child">
							...
							<div class="form-group">
								<select class="form-control" id="newbankaccount"
									name="newbankaccount">
				...
				<section class="section-box-acc">
					...
					<div class="btn-hr">
						<a href="account_index.jsp" class="btn btn-danger">Back</a>
	...
	<script>
		$(function() {
			...
			$("#newbankaccount").css("background", "red");
