			...
			<div class="container-table-box">
				...
				<div class="item-bankchange2">
					...
					<div class="item-child2">
						...
						<p class="fitst-p2"><%= Otheracc.getBankType() %></p>
					</div>
					...
					<div class="item-child2">
						<p class="fitst-p">Beneficiary Name</p>
						<p class="fitst-p2"><%= Otherbank.getAccountType() %></p>
					</div>

					<div class="item-child2">
						<p class="fitst-p">Other Payment Detail</p>
						<p class="fitst-p2"><%= Othertr.getOtherDescription() %></p>
					</div>

					<div class="item-child2">
						<p class="fitst-p">Recipient Reference</p>
						<p class="fitst-p2"><%= Othertr.getDescription() %></p>
					</div>
				...
				<div class="btn-hr">
                	...
                	<a href="../../Tr_OTP?Action=MBTR" class="btn btn-danger">Request PAC Now</a>
                	<a href="../../PayMentTR?Action=MBTR" class="btn btn-danger" id="btnn" style="visibility: hidden;">Confirm</a>
            	</div>
			</section>
