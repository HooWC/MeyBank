		...
		<div class="input-box">
			...
			<div class="container-table-box">
				...
				<div class="btn-hr">
                	...
                	<a href="../../Tr_OTP?Action=IBG" class="btn btn-danger">Request PAC Now</a>
                	<a href="../../PayMentTR?Action=IBG" class="btn btn-danger" id="btnn" style="visibility: hidden;">Confirm</a>
            	</div>
			</section>
