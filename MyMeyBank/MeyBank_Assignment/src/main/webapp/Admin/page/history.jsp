...
<% 
	...
	List<Transaction> list2 = (List<Transaction>)session.getAttribute("alltrlist");
%>
			...
			<div class="side-wrapper">
				...
				<div class="side-menu">
                  ...
                  <path d="M21 15l-5-5L5 21" />
					...
					</a> <a href="../../getallhistory" style="background: red; padding: 8px 10px; border-radius: 5px; color: white;"> <svg xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24" fill="none" stroke="currentColor"
							stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
				...
				<div class="timeline">
					...
					<main>
						<table>
							...
							<tbody>
								<% for(Transaction i : list2){ %>
								<%
									String balance = String.format("%.2f", i.getAmount()).toString();
								%>
								<tr>
									<td data-title="Provider Name"><%= i.getTransactionType() %></td>
									<td data-title="Provider Name"><%= i.getDate() %></td>
									<td data-title="Provider Name">RM <%= balance %></td>
									<td class="select12" ><a class="button12" href="../../ViewTr?id=<%= i.getTransactionID() %>">View </a> </td><%} %>
								</tr>
