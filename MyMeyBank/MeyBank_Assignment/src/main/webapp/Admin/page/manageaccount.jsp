...
<% 
	...
	List<Account> list2 = (List<Account>)session.getAttribute("allaccount");
%>
					...
					<main>
						<table>
							...
							<tbody>
								...
								<% 
									String m = "";
								if(i.getAccountStatus().equals("active")){
									m = "Blocked";
								}else{
									m = "Active";
								}
								...
								%>
								<tr>
									<td data-title="Provider Name"><%= i.getBankType() %></td>
									<td data-title="E-mail"><%= i.getVerifyWord() %></td>
									<td class="select12"><a class="button12" href="../../EditAccount?id=<%= i.getAccountID() %>">
											Edit </a> <a class="button12" href="../../BlockedAccount?id=<%= i.getAccountID() %>"> <%= m %> </a> <a
										class="button12" href="../../viewallbank?id=<%= i.getAccountID() %>"> View </a></td>
								</tr>
								<%} %>
							</tbody>
						</table>
