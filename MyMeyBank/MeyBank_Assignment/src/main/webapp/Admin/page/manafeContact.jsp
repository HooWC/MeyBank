...
<% 
	...
	List<Contact> list2 = (List<Contact>)session.getAttribute("allcontact");
%>
			...
			<div class="side-wrapper">
				...
				<div class="side-menu">
                  ...
                  <path d="M9 22V12h6v10" />
					...
					</a> <a href="m_user_home.jsp"> <svg stroke="currentColor"
							stroke-width="2" fill="none" stroke-linecap="round"
							stroke-linejoin="round" viewBox="0 0 24 24">
                  <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path>
                  <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path>
                </svg> Manage Users
					</a> <a href="../../getallaccount">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none"
							stroke="currentColor" stroke-width="2" stroke-linecap="round"
							stroke-linejoin="round" viewBox="0 0 24 24">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
                  <circle cx="12" cy="10" r="3" /></svg> Manage Account
					</a> <a href="../../getAllContent" style="background: red; padding: 8px 10px; border-radius: 5px; color: white;"> <svg xmlns="http://www.w3.org/2000/svg"
			...
			<div class="main-container">
				<div class="profile">
					<div class="profile-avatar">
						<img src="../../image/Admin/<%= ad.getIMG() %>" alt=""
							class="profile-img">
						...
						<table>
							<thead>
								<tr>
									...
									<th>Phone</th>
									<th>NRIC</th>
									<th style="width:320px;">Content</th>
									<th></th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									<td data-title="Provider Name"><%= i.getFullName() %></td>
									<td data-title="Provider Name"><%= i.getEmail() %></td>
									<td data-title="Provider Name"><%= i.getPhone() %></td>
									<td data-title="Provider Name"><%= i.getNRIC() %></td>
									<td data-title="E-mail" style="width:320px;"><%= i.getContent() %></td>
									<% if(i.isHandle() == false){ %>
									<td class="select12" ><a class="button12" href="../../EditContent?id=<%= i.getContactID() %>">Handle </a> </td>
									<% }else{ %>
